...
module.exports = function (grunt) {
  ...
  grunt.config.init({
    ...
    preprocess: {
      build: {
        files: {
          ...
          'dist/amd/marionette.handlebars.js': 'src/amd.js'
        }
      },
      interactive: {
        files: {
    ...
    concat: {
      ...
      amd_banner: {
        src: 'dist/amd/marionette.handlebars.js',
        dest: 'dist/amd/marionette.handlebars.js'
      }
    },
    ...
    uglify: {
      ...
      amd: {
        src: 'dist/amd/marionette.handlebars.js',
        dest: 'dist/amd/marionette.handlebars.min.js'
      },
      core: {
        src: 'dist/marionette.handlebars.js',
